...
export default function HomePage() {
  ...
  const getCurrentPriceAndWave = (event: EventWithWaves) => {
    ...
    if (!event.wave_1_sold_out && event.wave_1_price != null) {
      return { price: event.wave_1_price as number, label: 'WAVE 1', subtitle: 'EARLY BIRD', color: '#22c55e', soldOut: false }
    }
    if (event.wave_1_sold_out && !event.wave_2_sold_out && event.wave_2_price != null) {
      return { price: event.wave_2_price as number, label: 'WAVE 2', subtitle: 'REGULAR PRICE', color: '#eab308', soldOut: false }
    }
    if (event.wave_1_sold_out && event.wave_2_sold_out && !event.wave_3_sold_out && event.wave_3_price != null) {
      return { price: event.wave_3_price as number, label: 'WAVE 3', subtitle: 'LAST WAVE', color: '#3b82f6', soldOut: false }
    }
    ...
    <main style={{ backgroundColor: '#050505', minHeight: '100vh', fontFamily: 'Inter, sans-serif' }}>
      ...
      <section id="events" style={{ padding: '56px 16px', backgroundColor: '#050505' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          ...
          >
            <div>
              <p style={{ color: '#dc2626', fontSize: '11px', letterSpacing: '4px', fontWeight: 700, margin: '0 0 8px' }}>● UPCOMING</p>
              <h2 style={{ fontSize: isMobile ? '26px' : '36px', fontWeight: 900, color: '#fff', margin: 0, letterSpacing: '-1px' }}>
                EVENTS
              </h2>
            </div>
            <Link
          ...
          <div style={{ overflowX: 'auto', paddingBottom: '8px' }}>
            <div
              style={{
                ...
                gap: '20px',
                minWidth: events.length > 3 ? `${events.length * 280}px` : 'auto',
              }}
            >
              {events.map(event => {
  ...
  >
    ...
    <p style={{ color: '#fff', fontWeight: 900, fontSize: '17px', margin: 0 }}>
      ...
      {/* DJs SECTION */}
      <section id="djs" style={{ padding: '56px 16px', backgroundColor: '#0a0a0a', borderTop: '1px solid #111' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          <div
            style={{
              display: 'flex',
          ...
          >
            <div>
              <p style={{ color: '#dc2626', fontSize: '11px', letterSpacing: '4px', fontWeight: 700, margin: '0 0 8px' }}>● FEATURED</p>
              <h2 style={{ fontSize: isMobile ? '26px' : '36px', fontWeight: 900, color: '#fff', margin: 0, letterSpacing: '-1px' }}>
                DJs
              </h2>
            </div>
            ...
            <div style={{ overflowX: 'auto', paddingBottom: '8px' }}>
              <div
                style={{
                  ...
                  gap: '20px',
                  minWidth: djs.length > 4 ? `${djs.length * 240}px` : 'auto',
                }}
              >
                {djs.map(dj => (
                  <div
      ...
      <section id="about" style={{ padding: '72px 16px', backgroundColor: '#050505', borderTop: '1px solid #111' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
          <p style={{ color: '#dc2626', fontSize: '11px', letterSpacing: '4px', fontWeight: 700, margin: '0 0 12px' }}>● ABOUT US</p>
          <h2 style={{ fontSize: '32px', fontWeight: 900, color: '#fff', margin: '0 0 20px', letterSpacing: '-1px' }}>WHO WE ARE</h2>
          <div style={{ width: '60px', height: '3px', background: 'linear-gradient(90deg, #dc2626, transparent)', borderRadius: '2px', margin: '0 auto 28px' }} />
          <p style={{ color: '#555', fontSize: '15px', lineHeight: 1.9, margin: '0 0 16px' }}>
            GRAVIX is Egypt&apos;s premier live events platform. We connect music lovers, culture seekers, and night-life enthusiasts with the most exclusive events across the country.
          </p>
          <p style={{ color: '#444', fontSize: '14px', lineHeight: 1.9, margin: 0 }}>
            From intimate underground concerts to large-scale festivals — we handle bookings, payments, and entry management so you can focus on the experience.
          </p>
        </div>
      </section>
      ...
      <section id="contact" style={{ padding: '72px 16px', backgroundColor: '#0a0a0a', borderTop: '1px solid #111' }}>
        <div style={{ maxWidth: '700px', margin: '0 auto', textAlign: 'center' }}>
          <p style={{ color: '#dc2626', fontSize: '11px', letterSpacing: '4px', fontWeight: 700, margin: '0 0 14px' }}>● GET IN TOUCH</p>
          <h2 style={{ fontSize: '32px', fontWeight: 900, color: '#fff', margin: '0 0 16px', letterSpacing: '-1px' }}>CONTACT US</h2>
          <div style={{ width: '60px', height: '3px', background: 'linear-gradient(90deg, #dc2626, transparent)', borderRadius: '2px', margin: '0 auto 40px' }} />
          ...
          <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : 'repeat(3, 1fr)', gap: '16px' }}>
            {[
              ...
              <a key={c.label} href={c.href} target={c.external ? '_blank' : undefined} rel={c.external ? 'noreferrer' : undefined} style={{ textDecoration: 'none' }}>
                <div
                  style={{
                    backgroundColor: '#0d0d0d',
                    border: '1px solid #1a1a1a',
                ...
                >
                  ...
                  <p style={{ color: '#fff', fontSize: '13px', fontWeight: 700, margin: 0 }}>{c.value}</p>
                </div>
              </a>
            ))}
          </div>
      ...
      <footer style={{ borderTop: '1px solid #111', padding: '32px 16px', textAlign: 'center', backgroundColor: '#050505' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', gap: '16px', marginBottom: '16px', flexWrap: 'wrap' }}>
          <a href="https://instagram.com/gravix_eg" target="_blank" rel="noreferrer" style={{ color: '#333', fontSize: '12px', textDecoration: 'none', letterSpacing: '1px' }}>INSTAGRAM</a>
          <a href="https://wa.me/201093379437" target="_blank" rel="noreferrer" style={{ color: '#333', fontSize: '12px', textDecoration: 'none', letterSpacing: '1px' }}>WHATSAPP</a>
          <a href="mailto:gravixegypt@gmail.com" style={{ color: '#333', fontSize: '12px', textDecoration: 'none', letterSpacing: '1px' }}>EMAIL</a>
          <Link href="/events" style={{ color: '#333', fontSize: '12px', textDecoration: 'none', letterSpacing: '1px' }}>EVENTS</Link>
          <Link href="/djs" style={{ color: '#333', fontSize: '12px', textDecoration: 'none', letterSpacing: '1px' }}>DJs</Link>
        </div>
