    ...
    <main style={{ minHeight: '100vh', backgroundColor: '#050505', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px', fontFamily: 'Inter, sans-serif' }}>
      <div style={{ width: '100%', maxWidth: '420px' }}>
        <div style={{ textAlign: 'center', marginBottom: '40px' }}>
          ...
          <p style={{ color: '#444', fontSize: '13px', letterSpacing: '2px', marginTop: '8px' }}>CREATE YOUR ACCOUNT</p>
        </div>

        <div style={{ backgroundColor: '#0d0d0d', border: '1px solid #1a1a1a', borderRadius: '20px', padding: '40px' }}>
          {error && (
            <div style={{ backgroundColor: 'rgba(239,68,68,0.1)', border: '1px solid rgba(239,68,68,0.3)', borderRadius: '10px', padding: '12px 16px', color: '#ef4444', fontSize: '13px', marginBottom: '20px' }}>
              {error}
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            <div>
              <p style={{ color: '#444', fontSize: '10px', letterSpacing: '2px', fontWeight: 700, margin: '0 0 8px' }}>EMAIL</p>
              <input
            ...
            <button type="submit" disabled={loading} style={{
              ...
              letterSpacing: '2px', fontFamily: 'Inter, sans-serif', marginTop: '8px'
            }}>
          ...
          <p style={{ textAlign: 'center', color: '#333', fontSize: '13px', marginTop: '24px' }}>
            ...
            <Link href="/auth/login" style={{ color: '#dc2626', textDecoration: 'none', fontWeight: 700 }}>SIGN IN</Link>
          </p>
        </div>
      </div>
    </main>
