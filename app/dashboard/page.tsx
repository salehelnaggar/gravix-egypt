...
const roleAccess: Record<string, string[]> = {
  superadmin: ['events', 'reservations', 'verify', 'djs', 'users', 'partners'],
...
export default function DashboardPage() {
  ...
  const loadStats = async () => {
    ...
    setStats({
      ...
      tickets: confirmed.reduce(
        (sum, r) => sum + (r.num_people || 0),
        0
      ),
  ...
  const allNavCards = [
    ...
    },
    {
      ...
      icon: '🔍',
      title: 'VERIFY ENTRY',
      sub: 'Scan entry codes at the door',
    },
    {
      key: 'djs',
      href: '/dashboard/djs',
    ...
    },
    {
      ...
      icon: '👥',
      title: 'MANAGE USERS',
      sub: 'Add & control admin access',
    },
    // الكارت الجديد للبارتنرز
    {
      key: 'partners',
      href: '/dashboard/partners',
      icon: '🤝',
      title: 'MANAGE PARTNERS',
      sub: 'Exclusive brands working with GRAVIX',
      highlight: true,
    },
  ]
      ...
      <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          ...
          <div>
            ...
            >
              ...
              {role && (
                <span
                  style={{
                    backgroundColor: `${roleBadgeColor[role] || '#555'}18`,
                    border: `1px solid ${
                      roleBadgeColor[role] || '#555'
                    }40`,
                    color: roleBadgeColor[role] || '#555',
                    fontSize: '9px',
                    fontWeight: 700,
                    letterSpacing: '2px',
                    padding: '3px 10px',
        ...
        <div
          style={{
            display: 'grid',
            gridTemplateColumns:
              visibleCards.length === 1 ? '1fr' : 'repeat(2, 1fr)',
            gap: '20px',
          }}
        >
